    ...
    <footer className="footerHome pb-5 lg:px-10">
      <div className="footer__content containerCss">
        ...
        <div className="footer__bottom grid grid-cols-12 py-8">
          <div
            className="footerBottom__item col-span-2 md:col-span-3 md:justify-self-center sm:col-span-12 sm:mb-3"
            style={{ width: "100px" }}
          >
          ...
          <div
            className="footerBottom__item col-span-2 md:col-span-3 md:justify-self-center sm:col-span-12"
            style={{ width: "100px" }}
          >
